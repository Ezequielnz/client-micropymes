...
const CompraCreateModal = ({
  ...
  useEffect(() => {
    if (open) {
      setHeader({ proveedor_id: '', proveedor_nombre: '', fecha: todayStr(), observaciones: '' });
      setItems([]);
    }
  }, [open]);
  ...
  return (
    <div style={{ position: 'fixed', inset: 0, backgroundColor: 'rgba(0,0,0,0.5)', display: 'flex', alignItems: 'center', justifyContent: 'center', zIndex: 1000 }}>
      <div style={{ background: 'white', borderRadius: 8, padding: 20, width: '95%', maxWidth: 800, maxHeight: '90vh', overflow: 'auto' }}>
        <h2 style={{ fontSize: 18, fontWeight: 600, marginBottom: 16 }}>Nueva compra</h2>

        <form onSubmit={handleSubmit}>
          <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: 12 }}>
            <div>
              <label style={{ display: 'block', fontWeight: 600, marginBottom: 6 }}>Proveedor</label>
              <select
            ...
            <div>
              <label style={{ display: 'block', fontWeight: 600, marginBottom: 6 }}>Nombre proveedor (texto)</label>
              <input
                type="text"
          ...
          <div style={{ marginTop: 16 }}>
            <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: 6 }}>
              <h3 style={{ fontWeight: 600 }}>Ítems</h3>
  ...
  return (
    <div style={{ position: 'fixed', inset: 0, backgroundColor: 'rgba(0,0,0,0.5)', display: 'flex', alignItems: 'center', justifyContent: 'center', zIndex: 1000 }}>
      <div style={{ background: 'white', borderRadius: 8, padding: 20, width: '95%', maxWidth: 600, maxHeight: '90vh', overflow: 'auto' }}>
        <h2 style={{ fontSize: 18, fontWeight: 600, marginBottom: 16 }}>Editar compra</h2>
        <form onSubmit={handleSubmit}>
          <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: 12 }}>
            <div>
              <label style={{ display: 'block', fontWeight: 600, marginBottom: 6 }}>Proveedor</label>
    ...
    <div style={{ padding: 20, maxWidth: 1200, margin: '0 auto' }}>
      ...
      <div className="hidden md:block overflow-x-auto">
        <table className="w-full border-collapse">
          ...
          <tbody>
            {loadingPurchases ? (
              <tr><td colSpan={canEditStock ? 5 : 4} className="px-4 py-6 text-center text-gray-500">Cargando...</td></tr>
            ) : purchases.length === 0 ? (
              <tr><td colSpan={canEditStock ? 5 : 4} className="px-4 py-6 text-center text-gray-500 italic">No hay compras registradas</td></tr>
            ) : (
              purchases.map((c) => (
